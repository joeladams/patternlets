...
#     between pairs of processes, along with send/recv of a list.
#
...
def main():
    ...
    if numProcesses > 1 and not odd(numProcesses):
        ...
        print("Process {} of {} on {} computed {} and received {}".format(id, numProcesses, myHostName, sendList, receivedList))
