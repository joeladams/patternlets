...
//          modified 1/5/97
// 'unsigned' tweaks by Joel Adams, 2015/12/20
//
...
//    ~BigInt();
  ...
  private:
    ...
    unsigned NumDigits()   const;    // return # digits in number

    int  GetDigit(unsigned k) const;
    void AddSigDigit(int value);
    void ChangeDigit(unsigned k, int value);
    ...
    unsigned myNumDigits;       // stores # of digits of number
};
